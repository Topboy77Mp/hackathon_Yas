...
function ProductMark({ imageUrl, label }: { imageUrl: string; label: string }) {
  if (imageUrl) return <Box alt="" component="img" src={imageUrl} sx={{ width: 72, height: 72, borderRadius: 1, objectFit: "contain", bgcolor: "background.default" }} />;
  return <Box aria-label={label} sx={{ display: "grid", width: 72, height: 72, placeItems: "center", border: 1, borderColor: "divider", borderRadius: 1, bgcolor: "background.default", color: "text.secondary" }}><Inventory2Outlined /></Box>;
}
